...
export default function SymptomsPage() {
  ...
  const initialTab = (params.get("tab") as "search" | "browse" | "analysis") || "search"
  const openChat = params.get("chat") === "1"

  const [activeTab, setActiveTab] = useState<"search" | "browse" | "analysis">(initialTab)
        ...
        setChatMessages([
          {
            ...
            type: "assistant",
            content:
              "Hello! I’m your AI medical assistant. Describe your symptoms, and I’ll provide possible conditions, severity, and next steps. In emergencies, call 102 or 108.",
            timestamp: new Date(),
          },
        ])
      }
