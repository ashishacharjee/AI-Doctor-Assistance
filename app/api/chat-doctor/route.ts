// Temporary debug logging + robust provider fallback.
// Uses the AI SDK's generateText with OpenAI or Google Gemini. [^3]
...
export async function POST(req: Request) {
  ...
  try {
    ...
    // Safe input logging without secrets
...
5) Next steps (follow-up, tests, or doctor types)
    ...
    }) // AI SDK Core generateText with provider integration. [^3]
