  ...
  const symptomCategories: SymptomCategory[] = [
    {
      ...
      symptoms: ["Fever", "Fatigue", "Weakness", "Loss of appetite", "Weight loss", "Night sweats", "Chills"],
    },
    {
      name: "Respiratory",
      icon: <Activity className="h-5 w-5" />,
      color: "bg-green-100 text-green-800",
      symptoms: ["Cough", "Shortness of breath", "Chest pain", "Wheezing", "Sore throat", "Runny nose", "Sneezing"],
    },
    {
      name: "Digestive",
      icon: <Activity className="h-5 w-5" />,
    ...
    },
    {
      ...
      symptoms: ["Headache", "Dizziness", "Confusion", "Memory problems", "Seizures", "Numbness", "Tingling"],
    },
    {
      name: "Cardiovascular",
      icon: <Heart className="h-5 w-5" />,
      color: "bg-red-100 text-red-800",
      symptoms: ["Chest pain", "Palpitations", "Irregular heartbeat", "Swelling", "High blood pressure", "Fainting"],
    },
    {
  ...
  const handleChatSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = {
        ...
        type: "assistant",
        content:
          "I apologize, but I'm having trouble connecting right now. Please try again or consider consulting with a healthcare professional directly.",
        timestamp: new Date(),
      }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Describe your symptoms and get instant AI-powered health insights. Our advanced medical AI can help identify
            potential conditions and provide guidance on next steps.
          </p>
        </div>
        ...
        <Alert className="mb-8 border-red-200 bg-red-50">
          ...
          <AlertDescription className="text-red-800">
            <strong>Important:</strong> This AI analysis is for informational purposes only and should not replace
            professional medical advice. Always consult with a qualified healthcare provider for proper diagnosis and
            treatment. In case of emergency, call 102 (Ambulance) or 108 (Emergency Services) immediately.
          </AlertDescription>
        </Alert>
